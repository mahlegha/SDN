...
#        self.W = np.zeros(shape=(1,1,10))
        ...
        # self.A[7][8]=1
        # self.A[8][7]=1
        self.B = np.zeros(shape=(7,40))
        self.C = np.zeros(shape=(7,40))
        self.D = np.zeros(shape=(1,41))
        self.Z = np.zeros(shape=(1,7,40))
        self.W = np.zeros(shape=(1,1,41))
