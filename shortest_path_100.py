...
#        self.W = np.zeros(shape=(1,1,10))
        ...
        # self.A[7][8]=1
        # self.A[8][7]=1
        self.B = np.zeros(shape=(7,100))
        self.C = np.zeros(shape=(7,100))
        self.D = np.zeros(shape=(1,101))
        self.Z = np.zeros(shape=(1,7,100))
        self.W = np.zeros(shape=(1,1,101))
...
#                        self.G[src_switch_dpid][dst_switch_dpid]['weight'] = self.set_weight(1.0)
    ...
    def _packet_in_handler(self, ev):
        ...
        self.hosts1 = ['00:00:00:00:00:10','00:00:00:00:00:20','00:00:00:00:00:30','00:00:00:00:00:40',
                      '00:00:00:00:00:50','00:00:00:00:00:60','00:00:00:00:00:70','00:00:00:00:00:80'
                      ,'00:00:00:00:00:90']

        self.hosts2 = ['00:00:00:00:10:00','00:00:00:00:11:00','00:00:00:00:20:00','00:00:00:00:21:00',
                      '00:00:00:00:30:00','00:00:00:00:31:00','00:00:00:00:40:00','00:00:00:00:41:00',
                      '00:00:00:00:50:00','00:00:00:00:51:00','00:00:00:00:60:00','00:00:00:00:61:00'
                      ,'00:00:00:00:70:00','00:00:00:00:71:00','00:00:00:00:80:00','00:00:00:00:81:00'
                      ,'00:00:00:00:90:00','00:00:00:00:91:00'] 
        ...
        if dst not in self.G:
            ...
            if dpid != d_sw:
                ...
                sio.savemat('next_hop_30.mat', {'w':self.W})
            ...
            sio.savemat('matrix_state_30.mat', {'z':self.Z})
        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if msg.buffer_id != ofproto.OFP_NO_BUFFER:
                self.add_flow(datapath, 1, match, actions, msg.buffer_id, 30)
            else:
